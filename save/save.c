...
unsigned char	*create_bitmap_info_header(t_rc *rc)
{
	...
	info_header[4] = (unsigned char)(rc->pars->Ry >> 0);
	info_header[5] = (unsigned char)(rc->pars->Ry >> 8);
	info_header[6] = (unsigned char)(rc->pars->Ry >> 16);
	info_header[7] = (unsigned char)(rc->pars->Ry >> 24);
	info_header[8] = (unsigned char)(rc->pars->Rx >> 0);
	info_header[9] = (unsigned char)(rc->pars->Rx >> 8);
	info_header[10] = (unsigned char)(rc->pars->Rx >> 16);
	info_header[11] = (unsigned char)(rc->pars->Rx >> 24);
